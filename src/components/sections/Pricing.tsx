  ...
  const plans: Plan[] = [
    {
      ...
      features: [t('basicF1'), t('basicF2'), t('basicF3'), t('basicF4')].filter(Boolean),
      disclaimer: t('basicDisclaimer'),
    },
    {
      id: 'plan-advanced',
      name: t('advanced'),
      ...
      features: [t('advancedF1'), t('advancedF2'), t('advancedF3'), t('advancedF4')].filter(Boolean),
      badge: t('popular'),
      disclaimer: t('advancedDisclaimer'),
    },
    {
      id: 'plan-premium',
      name: t('premium'),
      ...
      features: [t('premiumF1'), t('premiumF2'), t('premiumF3'), t('premiumF4'), t('premiumF5'), t('premiumF6')].filter(Boolean),
      badge: t('save35'),
